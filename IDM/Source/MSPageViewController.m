...
- (void)viewDidLoad {
    ...
    if (self.pageCount == 1) self.view.userInteractionEnabled = NO;
...
- (UIViewController *)viewControllerAtIndex:(NSInteger)index {
    ...
    if (index >= 0 && index < self.pageCount) {
        NSAssert(self.storyboard, @"This controller is only meant to be used inside of a UIStoryboard");
        ...
        [self setUpViewController:result atIndex:index];
    }
