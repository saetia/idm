...
- (void)seedData {
    ...
    NSArray *json = @[
                     @{
                         ...
                         @"website":                    @"http://www.edge-waterresort.com",
                     ...
                     @{
                         ...
                         @"website":                    @"http://www.hoteljuliendubuque.com",
                     ...
                     @{
                         ...
                         @"website":                    @"http://www.hotelmarshfield.com",
                     ...
                     @{
                         ...
                         @"website":                    @"http://www.jeffersonstreetinn.com",
                     ...
                     @{
                         ...
                         @"website":                    @"http://www.plazahotelmilwaukee.com",
                     ...
                     @{
                         ...
                         @"website":                    @"http://www.cranberrycountrylodge.com",
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        //controller.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCamera target:nil action:nil];
